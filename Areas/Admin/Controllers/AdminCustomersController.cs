...
namespace Ecommerce_web_app.Areas.Admin.Controllers
{
	...
	public class AdminCustomersController : Controller
	{
		...
		public AdminCustomersController(EcommerceContext context)
		{
			_context = context;
		}
		...
		public async Task<IActionResult> Create([Bind("CustomerId,FullName,Birthday,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateDate,LastLogin,Active,Salt")] Customer customer)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FullName,Birthday,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateDate,LastLogin,Active,Salt")] Customer customer)
		{
